...
CAMPAIGN_MAPS = [
    ...
    (
        "c2",
        ["m1_highway", "m2_fairgrounds", "m3_coaster", "m4_barns", "m5_concert"],
        False,
    ),  # Dark Carnival
    (
        "c3",
        ["m1_plankcountry", "m2_swamp", "m3_shantytown", "m4_plantation"],
        False,
    ),  # Swamp Fever
    (
        "c4",
    ...
    (
        "c5",
        ["m1_waterfront", "m2_park", "m3_cemetery", "m4_quarter", "m5_bridge"],
        False,
    ),  # The Parish
    ("c7", ["m1_docks", "m2_barge", "m3_port"], True),  # The Sacrifice
    (
        "c8",
        ["m1_apartment", "m2_subway", "m3_sewers", "m4_interior", "m5_rooftop"],
        True,
    ),  # No Mercy
    ("c9", ["m1_alleys", "m2_lots"], True),  # Crash Course
    (
        "c10",
        ["m1_caves", "m2_drainage", "m3_ranchhouse", "m4_mainstreet", "m5_houseboat"],
        True,
    ),  # Death Toll
    (
        "c11",
        ["m1_greenhouse", "m2_offices", "m3_garage", "m4_terminal", "m5_runway"],
        True,
    ),  # Dead Air
    (
        "c12",
        ["m1_hilltop", "m2_traintunnel", "m3_bridge", "m4_barn", "m5_cornfield"],
        True,
    ),  # Blood Harvest
    (
        "c13",
